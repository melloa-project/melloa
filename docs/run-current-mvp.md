...
8. Open **Memory**, paste the printed seed assertion ID, and inspect its value and append-only state history. Corrections require the recent in-memory mutation proof established at login.
