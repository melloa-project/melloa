...
- Capture is disabled, media content is never served, backup is unconfigured, and only owner-conversation plus owner-memory retention inventory is backed by canonical stores.
